    ...
    <div class="stock-form-card supplier-form-card">
        ...
        <div class="stock-form-header">
            ...
            <div>
                ...
                <p>
                    Enregistrer un nouveau partenaire du restaurant
                </p>
        ...
        <form action="/admin/suppliers"
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       placeholder="Ex: Kay-Y Distribution"
                       required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('produits_fournis') }}"
                           placeholder="Viandes, boissons...">
